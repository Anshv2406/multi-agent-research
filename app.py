...
<div class="hero">
    ...
    <p class="hero-sub">
        Five specialized AI agents collaborate — searching, scraping, writing,
        fact-checking, and critiquing — to deliver a polished research report on any topic.
    </p>
</div>
...
with col_pipeline:
    ...
    def s(step):
        ...
        steps = ["search", "reader", "writer", "fact_checker", "critic"]
...
if st.session_state.running and not st.session_state.done:
    ...
    with st.spinner("✍️ Writer is drafting the report…"):
        ...
        # Cap combined research length to avoid blowing past the model's
        # context window on broad topics. Rough heuristic: ~4 chars/token,
        # keeping this well under typical context limits.
    ...
    # ── Step 4: Fact Checker ──
    with st.spinner("🔎 Fact Checker is verifying claims…"):

        results["fact_checker"] = fact_checker_chain.invoke({
            "source_content": results["reader"],
